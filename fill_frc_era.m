...
start_date = datenum(2012,11,1);
end_date   = datenum(2013,4,1);

grdname = '/paracas/ROMS_SOLUTIONS/SWELL/nepac4km_grd.nc';
disname = '/paracas/ROMS_SOLUTIONS/SWELL/nepac4km_cdist.mat';
...
for i = 1:nfiles
 ...
 frcname = [root_name '_frc_' label '.nc'] 
